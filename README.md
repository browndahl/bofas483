...
- Persistent colony management adds priority levels, emergency/repair/reserve/staffing policies, protected work/free/rest schedules, safe shift limits, three crew zones, preferred facility operators, capacity forecasts, and an explainable job queue. These systems guide autonomy without bypassing urgent care, route safety, or player-assigned roles.
