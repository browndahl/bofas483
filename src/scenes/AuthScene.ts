...
export class AuthScene extends Phaser.Scene {
  ...
  async create() {
    ...
    crisp(this.add.text(width / 2 - cardWidth / 2 + 28, height / 2 - 155, identityLabel, { fontFamily: UI_FONT, fontStyle: 'bold', fontSize: '12px', color: '#a8cdbb', wordWrap: { width: cardWidth - 56 } }));
